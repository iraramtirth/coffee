 ...
 * Original file: E:\\Workspaces\\MyEclipse9\\froyo\\src\\android\\os\\IPowerManager.aidl
 */
package android.os;
/** @hide */
...
static final int TRANSACTION_goToSleep = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_goToSleepWithReason = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_releaseWakeLock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_userActivity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_userActivityWithForce = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_clearUserActivityTimeout = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_setPokeLock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getSupportedWakeLockFlags = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_setStayOnSetting = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_setMaximumScreenOffTimeount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_preventScreenOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_isScreenOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_reboot = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_crash = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_setBacklightBrightness = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
