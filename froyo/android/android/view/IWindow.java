 ...
 * Original file: E:\\Workspaces\\MyEclipse9\\froyo\\src\\android\\view\\IWindow.aidl
 */
...
mRemote.transact(Stub.TRANSACTION_dispatchKey, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
}
public void dispatchPointer(android.view.MotionEvent event, long eventTime, boolean callWhenDone) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
public void dispatchTrackball(android.view.MotionEvent event, long eventTime, boolean callWhenDone) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
_data.writeLong(eventTime);
_data.writeInt(((callWhenDone)?(1):(0)));
mRemote.transact(Stub.TRANSACTION_dispatchTrackball, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_dispatchKey = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_dispatchPointer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_dispatchTrackball = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_dispatchAppVisibility = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_dispatchGetNewSurface = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_windowFocusChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_closeSystemDialogs = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_dispatchWallpaperOffsets = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_dispatchWallpaperCommand = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
}
/**
     * ===== NOTICE =====
     * The first method must remain the first method. Scripts
