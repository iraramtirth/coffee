 ...
 * Original file: E:\\Workspaces\\MyEclipse9\\froyo\\src\\android\\view\\IWindowManager.aidl
 */
...
static final int TRANSACTION_pauseKeyDispatching = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_resumeKeyDispatching = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_setEventDispatching = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_addWindowToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_removeWindowToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_addAppToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_setAppGroupId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_setAppOrientation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_getAppOrientation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_setFocusedApp = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_prepareAppTransition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_getPendingAppTransition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_overridePendingAppTransition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_executeAppTransition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_setAppStartingWindow = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_setAppWillBeHidden = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_setAppVisibility = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_startAppFreezingScreen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_stopAppFreezingScreen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_removeAppToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_moveAppToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_moveAppTokensToTop = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_moveAppTokensToBottom = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_updateOrientationFromAppTokens = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_setNewConfiguration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_disableKeyguard = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_reenableKeyguard = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_exitKeyguardSecurely = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_inKeyguardRestrictedInputMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_closeSystemDialogs = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_getAnimationScale = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_getAnimationScales = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_setAnimationScale = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_setAnimationScales = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_getSwitchState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_getSwitchStateForDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_getScancodeState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_getScancodeStateForDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_getTrackballScancodeState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_getDPadScancodeState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_getKeycodeState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_getKeycodeStateForDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_getTrackballKeycodeState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_getDPadKeycodeState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_hasKeys = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_setInTouchMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_setRotation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
