...
public class CollectionUtils {
	...
	public static Map<String, Integer> sortMapByValue(
			final Map<String, Integer> map, final SortType sortType) {
	 ...
	 * key按照中文拼音首字母排序
	 */
	public static Map<String, String> sortMapByPinyin(
	...
	public static void main(String[] args) {
		...
		// System.out.println(CollectionUtils.sortMapByValue(map,
		// SortType.BigToSmall));
		System.out.println(CollectionUtils.sortMapByPinyin(map));
	}
