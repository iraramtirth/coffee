...
public class Pinyin {
	public static void main(String[] args) {
		...
		try {
			...
			outputFormat.setCaseType(HanyuPinyinCaseType.LOWERCASE);//转成大写
			outputFormat.setVCharType(HanyuPinyinVCharType.WITH_U_UNICODE);	// Options Output 
			//			WITH_U_AND_COLON u: 
			//				WITH_V v 
			//				WITH_U_UNICODE ü 

			outputFormat.setToneType(HanyuPinyinToneType.WITH_TONE_MARK);//声调方式
//			Options Output 
...
//			for (char cha : chars) {
//				System.out.print("\n"+cha);
//				String[] sty = PinyinHelper.toHanyuPinyinStringArray(cha);
//				if(sty!=null)
//				for (String str : sty) {
//					System.out.print(str+" ");
//				}
...
//			System.out.println("\n----------------------------");
			for (char cha : chars) {
				...
				if(sty!=null){
					System.out.print(sty[0]+" ");
				}
			}
//			System.out.println("\n---------------------------");
//			for (char cha : chars) {
//				System.out.print("\n"+cha);
//				String[] sty = PinyinHelper.toMPS2PinyinStringArray(cha);
//				if(sty!=null)
//				for (String str : sty) {
//					System.out.print(str+" ");
//				}
