/*
 * 文件名: BaseContactModel.java 版 权： Copyright Huawei Tech. Co. Ltd. All Rights
 * Reserved. 描 述: [该类的简要描述] 创建人: 杨凡 创建时间:2011-10-17 修改人： 修改时间: 修改内容：[修改内容]
 */
package coffee.test;
...
public class BaseContactModel implements Serializable
{
    ...
    /**
     * 联系人显示的名称 显示名称，查询时逻辑层根据 '备注名称'、'真实名称'、'昵称'、'账号'的优先级计算
     */
