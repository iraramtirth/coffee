...
/**
 * logcat [<option>] ... [<filter-spec>] ... 注意：filter-spec必须放在最后
...
public class LogService extends Service {
	...
	public void onCreate() {
		...
		Log.d(TAG, "onCreate");
		// 挂载了内存卡
		if (Environment.getExternalStorageState().contains(
		...
		String cmdLine = "logcat -v time *"; // -v 是格式化，意思是输出时间 *:E *代表任意TAG，
												// E指的是过滤级别
		try {
