package org.coffee.util.adapter;
...
public class OnGestureEvent implements View.OnTouchListener, OnGestureListener,
	...
	/**
	 * 该方法来自OnTouchListener
	 * //gestureDetector通过OnTouchListener间接响应
	 */
	@Override
	...
	/**
	 * 扩展与onScroll(e1, e2, distanceX, distanceY)不同的是
	 * e1、e2都不断触发
