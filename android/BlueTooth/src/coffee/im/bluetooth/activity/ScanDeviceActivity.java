...
//
//	private List<ContactBean> infoList = new ArrayList<ContactBean>();
...
//		ContactBean info = this.infoList.get(position);
//		if (info.isPair()) {
//			menu.add(0, 3, 1, "连接设备");
//			menu.add(0, 2, 2, "解除配对");
//		} else {
...
//		BluetoothDevice remoteDevice = mBtAdapter
//				.getRemoteDevice(selectedDeviceAddress);
