...
//            manager.setDiscoverableTimeout(timeout);
            Exe.run(manager, "setDiscoverableTimeout", "timeout");
...
//            manager.setScanMode(BluetoothAdapter.SCAN_MODE_CONNECTABLE_DISCOVERABLE);
            Exe.run(manager, "setScanMode", BluetoothAdapter.SCAN_MODE_CONNECTABLE_DISCOVERABLE);
        } else {
//            manager.setScanMode(BluetoothAdapter.SCAN_MODE_CONNECTABLE);
        	 Exe.run(manager, "setScanMode", BluetoothAdapter.SCAN_MODE_CONNECTABLE);
        }
    }
