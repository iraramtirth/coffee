...
public class BluetoothEventRedirector {
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothAdapter.ACTION_STATE_CHANGED)) {
            ...
            } else if (action.equals(Exe.getValue(BluetoothDevice.class, "ACTION_DISAPPEARED"))) {
                ...
                if (bondState == BluetoothDevice.BOND_NONE) {
                    if ((Boolean)Exe.run(device, "isBluetoothDock", new Object[]{})) {
                    ...
                    int reason = intent.getIntExtra(Exe.getValue(BluetoothDevice.class, "EXTRA_REASON") + "",
                            BluetoothDevice.ERROR);
            ...
            } else if (action.equals(Exe.getValue(BluetoothDevice.class, "ACTION_UUID"))) {
                mManager.getCachedDeviceManager().onUuidChanged(device);

            } else if (action.equals(Exe.getValue(BluetoothDevice.class, "ACTION_PAIRING_CANCEL") + "")) {
    ...
    public void start() {
        ...
        filter.addAction(Exe.getValue(BluetoothDevice.class, "ACTION_DISAPPEARED") + "");
        filter.addAction(BluetoothDevice.ACTION_FOUND);
        filter.addAction(BluetoothDevice.ACTION_NAME_CHANGED);

        // Pairing broadcasts
        filter.addAction(BluetoothDevice.ACTION_BOND_STATE_CHANGED);
        filter.addAction(Exe.getValue(BluetoothDevice.class, "ACTION_PAIRING_CANCEL") + "");

        // Fine-grained state broadcasts
        filter.addAction(BluetoothA2dp.ACTION_SINK_STATE_CHANGED);
        filter.addAction(BluetoothHeadset.ACTION_STATE_CHANGED);
        filter.addAction(BluetoothDevice.ACTION_CLASS_CHANGED);
        filter.addAction(Exe.getValue(BluetoothDevice.class, "ACTION_UUID") + "");
