...
public class CachedBluetoothDeviceManager {
    ...
    public synchronized void showUnbondMessage(BluetoothDevice device, int reason) {
        ...
        switch(reason) {
        case IBluetoothDevice.UNBOND_REASON_AUTH_FAILED:
            errorMsg = R.string.bluetooth_pairing_pin_error_message;
            mLocalManager.showError(device, R.string.bluetooth_error_title, errorMsg);
            break;
        case IBluetoothDevice.UNBOND_REASON_AUTH_REJECTED:
            errorMsg = R.string.bluetooth_pairing_rejected_error_message;
            mLocalManager.showError(device, R.string.bluetooth_error_title, errorMsg);
            break;
        case IBluetoothDevice.UNBOND_REASON_REMOTE_DEVICE_DOWN:
            errorMsg = R.string.bluetooth_pairing_device_down_error_message;
            mLocalManager.showError(device, R.string.bluetooth_error_title, errorMsg);
            break;
        case IBluetoothDevice.UNBOND_REASON_DISCOVERY_IN_PROGRESS:
        case IBluetoothDevice.UNBOND_REASON_AUTH_TIMEOUT:
        case IBluetoothDevice.UNBOND_REASON_REPEATED_ATTEMPTS:
        case IBluetoothDevice.UNBOND_REASON_REMOTE_AUTH_CANCELED:
