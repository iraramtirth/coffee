...
public class PoiSearchActivity extends MapActivity implements OnClickListener
{
    // 定义地图引擎管理类
        ...
        mLocationListener = new LocationListener()
        {
            ...
            public void onLocationChanged(Location location)
            {
                if (location != null)
                {
                    ...
                    // 初始化
                    mMKSearch.init(mapManager,
                        new MySearchListener());
                    // 搜索贵州大学校门口附近500米范围的自动取款机
                    mMKSearch.poiSearchNearBy("ATM",
                        geoPoint,
                        500);
                }
            }
    ...
    public class MySearchListener implements MKSearchListener
    {
        ...
        public void onGetPoiResult(MKPoiResult result, int type, int iError)
        {
            ...
            PoiOverlay poioverlay = new PoiOverlay(PoiSearchActivity.this,
                mapView);
            // 设置搜索到的POI数据
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId())
        {
            case R.id.btn_search:
                int lon = (int) 39.904214;
                int lat = (int) 116.4253281;
                mMKSearch.reverseGeocode(new GeoPoint(lon,
                    lat));
                break;
