...
public abstract class AbstractProtocol implements ProtocolHandler, MBeanRegistration {
	...
	protected abstract static class AbstractConnectionHandler<S, P extends AbstractProcessor<S>> implements AbstractEndpoint.Handler {
			...
			if (getProtocol().getDomain() != null) {
				synchronized (this) {
					try {
						...
						ObjectName rpName = new ObjectName(getProtocol().getDomain() + ":type=RequestProcessor,worker=" + getProtocol().getName() + ",name=" + getProtocol().getProtocolName()
								+ "Request" + count);
