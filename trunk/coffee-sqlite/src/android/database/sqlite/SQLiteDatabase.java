...
public class SQLiteDatabase extends SQLiteClosable {
    ...
    /* package */ final boolean mLogStats = true;

    // System property that enables logging of slow queries. Specify the threshold in ms.
    private static final String LOG_SLOW_QUERIES_PROPERTY = "db.log.slow_query_threshold";
    private final int mSlowQueryThreshold = 1;
    ...
    public Cursor rawQueryWithFactory(
        ...
        SQLiteCursorDriver driver = null;//new SQLiteDirectCursorDriver(this, sql, editTable);

        driver = new SQLiteCursorDriver() {
			...
			@Override
			public Cursor query(CursorFactory factory, String[] bindArgs) {
				// TODO Auto-generated method stub
				return null;
			}
