 ...
 * Original file: E:\\Workspaces\\MyEclipse9\\froyo\\src\\android\\location\\ILocationProvider.aidl
 */
...
public void setMinTime(long minTime) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_getAccuracy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_enable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_disable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_getStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_getStatusUpdateTime = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_getInternalState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_enableLocationTracking = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_setMinTime = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_updateNetworkState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_updateLocation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_sendExtraCommand = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_addListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_removeListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
}
public boolean requiresNetwork() throws android.os.RemoteException;
public boolean requiresSatellite() throws android.os.RemoteException;
public boolean requiresCell() throws android.os.RemoteException;
