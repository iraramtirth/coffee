 ...
 * Original file: E:\\Workspaces\\MyEclipse9\\froyo\\src\\android\\hardware\\ISensorService.aidl
 */
...
/**
 * Cast an IBinder object into an android.hardware.ISensorService interface,
...
static final int TRANSACTION_getDataChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_enableSensor = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
}
public android.os.Bundle getDataChannel() throws android.os.RemoteException;
public boolean enableSensor(android.os.IBinder listener, java.lang.String name, int sensor, int enable) throws android.os.RemoteException;
}
