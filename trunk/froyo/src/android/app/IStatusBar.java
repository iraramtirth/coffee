 ...
 * Original file: E:\\Workspaces\\MyEclipse9\\froyo\\src\\android\\app\\IStatusBar.aidl
 */
package android.app;
/** @hide */
...
/**
 * Cast an IBinder object into an android.app.IStatusBar interface,
...
static final int TRANSACTION_deactivate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_toggle = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_disable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_addIcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_updateIcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_removeIcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
}
public void activate() throws android.os.RemoteException;
public void deactivate() throws android.os.RemoteException;
public void toggle() throws android.os.RemoteException;
